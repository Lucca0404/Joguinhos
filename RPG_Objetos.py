                ...
                while True:
                    ...
                    match choice.decode():
                        ...
                        case '3':
                            ...
                            if protagonist.items[target].category == 'heal':
                            ...
                            elif protagonist.items[target].category == 'weapon':
                                ...
                                if char_alive[target_e].aux_life <= 0:
                                    turn_order.remove(char_alive[target_e])
                                    char_alive.remove(char_alive[target_e])
                            break
                        case '4':
